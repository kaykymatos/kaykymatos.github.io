          ...
          <div className="card-body card-body-padding">
            <div className="mb-5">
              ...
              <div className="row row-cols-1 row-cols-md-3 g-3 text-center mb-4">
                <div className="col">
                  <div className="d-flex align-items-center bg-light rounded-4 p-3 h-100 justify-content-center">
              ...
              <div className="row row-cols-2 row-cols-md-3 row-cols-lg-5 text-center">
