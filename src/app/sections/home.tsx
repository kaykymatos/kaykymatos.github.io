                        ...
                        <div className="col-xxl-5">
                            <div className="text-center text-xxl-start">
                                <div className="badge bg-gradient-primary-to-secondary text-white mb-4">
                                    <div className="text-uppercase">Desenvolvedor &middot; Web</div>
                                </div>
                                <div className="fs-3 fw-light text-muted mt-5">Posso ajudar você e seu negócio!</div>
                                <h1 className="display-3 fw-bolder"><span className="text-gradient d-inline">Conhecimento
                                        nunca é de mais.</span></h1>
                                <div
                                    className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                    <a className="resume-button btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                        href="#experience">Resume</a>
                                    <a className="projects-button  btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder"
