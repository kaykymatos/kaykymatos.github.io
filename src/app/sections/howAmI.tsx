          ...
          <div className="row align-items-center gx-5">
            <div className="col-lg-12">
              ...
              <p>
                ...
                inovadores. Minha paixão por tecnologia me impulsiona a explorar
                constantemente novas ferramentas e frameworks, garantindo que
                estou atualizado com as melhores práticas do mercado.
              </p>
            </div>
          </div>
        </div>
