          ...
          <div className="col-lg-8">
            <div className="text-center my-5">
              ...
              <div className="d-flex flex-wrap justify-content-center mb-4">
                <Link style={styleLinks} className="mx-2" href="#home">
                  Home
                </Link>
                <Link style={styleLinks} className="mx-2" href="#howAmI">
                  Quem sou
                </Link>
                <Link style={styleLinks} className="mx-2" href="#experience">
                  Experiência
                </Link>
                <Link style={styleLinks} className="mx-2" href="#projects">
                  Projetos
                </Link>
                <Link style={styleLinks} className="mx-2" href="#education">
                  Formação
                </Link>
                <Link style={styleLinks} className="mx-2" href="#skills">
                  Skills
                </Link>
                <Link style={styleLinks} className="mx-2" href="#contact">
                  Contato
                </Link>
              </div>

              <div className="d-flex justify-content-center fs-2 gap-4 flex-wrap social-icons">
                <Link
                ...
                >
                  <svg
                    ...
                    width="40"
                    height="40"
                    className="bi bi-linkedin icon-with-gradient"
                    viewBox="0 0 16 16"
                  >
                    <defs>
                      <linearGradient
                      ...
                      >
                        ...
                        <stop offset="100%" style={{ stopColor: "#0617e3" }} />
                      </linearGradient>
                  ...
                  >
                    <defs>
                      <linearGradient
                        ...
                        y2="0%"
                      >
                        <stop offset="0%" style={{ stopColor: "#1e30f3" }} />
                        <stop offset="100%" style={{ stopColor: "#e21e80" }} />
                      </linearGradient>
                    </defs>
                    <path
              ...
              <h2 className="fw-bolder mt-4" style={{ color: "#1826c2" }}>
                Contato
              </h2>
              <p className="lead">
